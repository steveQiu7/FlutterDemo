...
class _Demo18ImagePickerForMultiplePhotosStatus extends State<Demo18ImagePickerForMultiplePhotos> {
  ...
  late final ValueNotifier<List<XFile>?> _imageFiles = ValueNotifier(null);
  ...
  Widget build(BuildContext context) {
    var body = ConstraintLayout(
      children: [
        buildBtnCameraImage(context).applyConstraint(id: _ids.btnCameraImage, width: wrapContent, height: wrapContent, top: parent.top.margin(10.h), centerHorizontalTo: parent),

        buildBtnGalleryImage(context).applyConstraint(id: _ids.btnGalleryImage, width: wrapContent, height: wrapContent, top: _ids.btnCameraImage.bottom.margin(10.h), centerHorizontalTo: parent),
  ...
  Widget _imageBuilder(BuildContext context, List<XFile>? imageFiles, Widget? child) {
    final wid = imageFiles == null
        ? Text(
          ...
          ).applyConstraint(id: _ids.tvNoPicture, width: wrapContent, height: wrapContent, top: _ids.btnGalleryImage.bottom.margin(10.h), centerHorizontalTo: parent)
